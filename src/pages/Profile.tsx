...
export default function Profile() {
  ...
  usePageLayout({
    mobileTitleBar: {
      title: authUser?.username || 'user profile',
      fallbackPath: '/',
    },
    hideBottomNav: true,
  });
    ...
    <div className='profile-app'>
      <div className='profile-phone'>
        <div className='profile-info'>
          ...
          {uploadingPhoto && (
            <p style={{ fontSize: 11, color: '#00B4A6', textAlign: 'center' }}>
              Uploading...
            </p>
          )}
        ...
        <div className='profile-bio-section'>
          {editingName ? (
            <div className='flex gap-2 mb-2'>
              ...
              />
              <button
                className='filter-sort-btn active'
                onClick={async () => {
          ...
          {editingBio ? (
            ...
            <div className='flex items-start justify-between'>
              ...
              <button
                ...
                className='text-xs text-teal-600 font-semibold hover:underline ml-2'
              >
                Edit
              </button>
            </div>
        ...
        <div className='posts-grid'>
          {(posts as IObservation[]).map((post, i) => (
            ...
            >
              {post.image?.image && (
                <img
                  src={post.image.thumbnail ?? post.image.image}
                  alt={post.speciesName}
                  className='post-img-full'
