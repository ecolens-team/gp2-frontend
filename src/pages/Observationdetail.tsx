      ...
      <div className='w-full max-w-4xl  min-h-screen overflow-y-auto'>
        ...
        <div className='bg-white rounded-2xl border border-teal-100 shadow-sm p-4 m-4'>
          <div className='flex justify-between items-center mb-3 gap-2'>
            ...
            <div className='bg-teal-50 text-teal-600 font-bold text-sm px-3 py-1 rounded-full border border-teal-300 whitespace-nowrap'>
              {confidenceLabel}
            </div>
          </div>
              ...
              if (availableQuests.length === 0) {
                return observation.assignedQuest ? (
                  <p className='text-xs text-gray-400 text-center py-1'>
                    No other joined quests to assign to.
                  </p>
                ) : (
                  <p className='text-xs text-gray-400 text-center py-1'>
        ...
        <div className='bg-white rounded-2xl border border-teal-100 shadow-sm p-4 mx-4 mb-6'>
          ...
          {commentsLoading ? (
            ...
            comments.map((comment, index) => (
              ...
              >
                <div className='w-8 h-8 rounded-full bg-teal-50 border-2 border-teal-100 flex items-center justify-center text-sm text-teal-600 font-bold shrink-0'>
