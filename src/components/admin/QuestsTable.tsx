                ...
                <div className='flex items-start justify-between gap-4'>
                  <div className='flex-1 min-w-0'>
                    <div className='flex items-center gap-2 mb-1.5 flex-wrap'>
                      <span
                        className={`flex items-center gap-1.5 text-[10px] font-bold px-2 py-0.5 rounded-full ${cfg.color}`}
                      >
                        <span
                    ...
                    <div className='flex flex-wrap items-center gap-4 mt-3 text-xs text-gray-400 font-medium'>
                      <span>
                        ...
                        <span className='text-gray-600 font-bold'>
                          @{quest.researcher_username}
                        </span>
                      </span>
                      <span className='flex items-center gap-1'>
                        <Users size={11} /> {quest.participant_count}{' '}
                        participants
                      </span>
                      <span className='flex items-center gap-1'>
                        <Trophy size={11} /> +{quest.reward_pts} pts
                      </span>
                      <span className='flex items-center gap-1'>
                        <Target size={11} /> {quest.target_count} obs. needed
                      </span>
                      <span className='flex items-center gap-1'>
                        <Clock size={11} />
