...
export default function BottomNavBar() {
    return(
        <nav className="fixed bottom-0 w-full bg-teal-50 border-t-2 border-teal-500/20 flex justify-around py-3 pb-safe md:hidden text-lg shadow-[0_-4px_10px_rgba(0,0,0,0.0.5)]">
