    ...
    return (
        <div className="bg-white border-b border-teal-100 p-3 sticky top-0 z-50 shadow-sm">
            <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
                ...
                <div className="relative flex-1 max-w-md ml-4" ref={ref}>
                    <div className="flex items-center border border-gray-200 rounded-full bg-gray-50 focus-within:ring-2 focus-within:ring-teal-500 focus-within:border-teal-500 focus-within:bg-white transition-all">
                        ...
                        <input
                            type="text"
                            className="flex-1 pl-2 pr-2 py-2 bg-transparent outline-none text-sm placeholder-gray-400"
                      ...
                      {search && (
                        ...
                        <button
                            ...
                            className={`pr-3 pl-1 transition-colors ${showFilters ? "text-teal-600" : "text-gray-400 hover:text-teal-500"}`}
                            title="Filters"
                        >
                                ...
                                >
                                  ...
                                  <img 
                                        src={authUser.profile_picture} 
                                          ...
                                          alt={authUser.first_name ? `${authUser.first_name}'s profile` : "Profile"} // <--- ضيف هذا السطر
                                               />
                                                  ) : (
