    ...
    return (
        <div style={{ position: 'fixed', bottom: '20px', right: '20px', zIndex: 9999 }}>
            <button 
                ...
                style={{ 
                    backgroundColor: '#008080', color: 'white', borderRadius: '50%', 
            ...
            {isOpen && (
                <div style={{ 
                    ...
                    width: '320px', height: '400px', backgroundColor: 'white', 
                    borderRadius: '12px', boxShadow: '0 10px 25px rgba(0,0,0,0.2)',
                    display: 'flex', flexDirection: 'column', overflow: 'hidden'
                }}>
                    <div style={{ padding: '15px', backgroundColor: '#008080', color: 'white', fontWeight: 'bold' }}>
                        EcoLens Chat
                    </div>
